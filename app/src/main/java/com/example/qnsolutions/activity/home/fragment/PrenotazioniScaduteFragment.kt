...
class PrenotazioniScaduteFragment(val list: MutableList<PrenotazioneModel>) : Fragment()
{
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View?
    {
        ...
        binding.recyclerView.adapter = PrenotazioneAdapter(list, requireContext(), false)
